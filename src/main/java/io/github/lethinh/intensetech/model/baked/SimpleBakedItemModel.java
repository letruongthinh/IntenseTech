...
public class SimpleBakedItemModel implements IBakedModel {

	private final boolean ambientOcclusion, gui3d;
	private final ItemOverrideList overrides;
	private final TextureAtlasSprite[] textures;

	public SimpleBakedItemModel(boolean ambientOcclusion, boolean gui3d, TextureAtlasSprite... textures) {
		this(ambientOcclusion, gui3d, ItemOverrideList.NONE, textures);
	}

	public SimpleBakedItemModel(boolean ambientOcclusion, boolean gui3d, ItemOverrideList overrides,
